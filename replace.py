...
start_marker = '<div className="bg-white rounded-[2.5rem] w-full max-w-[360px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-[#DCDCDA] flex flex-col overflow-hidden relative group transition-transform duration-500">'
end_marker = '              </div>\n            </motion.div>'
...
replacement = """<div className="bg-white rounded-[2.2rem] w-full max-w-[360px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-[#DCDCDA] p-2 flex flex-col overflow-hidden relative group transition-transform duration-500">
