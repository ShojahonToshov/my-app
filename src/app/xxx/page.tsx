...
import { 
  ...
  Users, Navigation, CheckCircle2, Lock, Ticket,
  ...
  return (
    <section className="min-h-screen bg-[#E6E8EA] text-black py-32 px-6 relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-bold tracking-tight leading-tight mb-6 pb-4 bg-gradient-to-b from-black via-black to-black/40 bg-clip-text text-transparent">
...
function Variant2LightSaaS() {
  return (
    <section className="min-h-screen bg-[#E6E8EA] text-black py-32 px-6 relative overflow-hidden font-sans border-t border-neutral-300">
      {/* Background glow adapted for light mode */}
      <motion.div 
        animate={{ 
          scale: [1, 1.1, 1],
